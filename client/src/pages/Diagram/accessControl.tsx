...
const AccessControlModal: React.FC<AccessControlModalProps> = ({
  ...
  // [CORE] function to get the access description
  ...
  // [CORE] function to save the configuration
        ...
        <form onSubmit={handleAddUser} className="mb-6 flex items-center gap-2">
          ...
          <button
            ...
            className={`bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-md transition-colors ${
              accessType === "public" ? "opacity-50 cursor-not-allowed" : ""
            }`}
            disabled={accessType === "public"}
          >
            Add
          ...
          <div className="mb-6">
            ...
            <div className="space-y-2 max-h-40 overflow-y-auto pr-2">
              ...
              <div className="flex items-center justify-between p-2 bg-gray-50 rounded-md">
                ...
                <span className="text-sm text-gray-500 px-2 py-1 rounded-full bg-gray-200">
                  Owner
                </span>
              </div>
          ...
          <div className="flex items-start gap-4 mb-4">
            <div
              className={`p-3 rounded-full ${
                accessType === "private" ? "bg-red-100" : "bg-green-100"
              }`}
            >
              {accessType === "private" ? (
            ...
            <div>
              <div className="relative">
                <select
                  value={accessType}
                  onChange={(e: ChangeEvent<HTMLSelectElement>) =>
                    handleAccessTypeChange(e.target.value as AccessType)
                  }
            ...
            {accessType === "public" && (
              <div className="relative ml-auto">
                <select
                  value={publicRole}
                  onChange={(e: ChangeEvent<HTMLSelectElement>) =>
                    setPublicRole(e.target.value as Role)
                  }
